...
#IMPORT FILES###################################################################
Ctry_Cont <- read.csv('source/Countries_Continents.csv', header = TRUE) #Countries and Continent
Ctry_income <- read.csv('source/income_groups.csv', header = TRUE) #Countries and income groups
#Set the distribution
Ava_dist <- setDT(read.csv('source/AvailabilityDist.csv', header = TRUE, fileEncoding='UTF-8-BOM')) #Self defined metadata distribution
#METADATA GENERATOR#############################################################
...
#SAVE DATA######################################################################
save(simmeta, file = 'temp/simmeta.RData')
