...
YNchoices <- levels(studymeta$ACCESS) #frequently used - No and Yes
YNMchoices <- levels(ppt_all_fc$MARISTAT)   #frequently used - No and Yes and Missing
...
metaVAR_info$LABELS  <- c('Study', 'Full Name', 
                          ...
                          'Administration', 'Demographics', 'Medical History', 'Family Disease History','Service Utilization', 
...
pVAR_info$LABELS  <- c('Study', 'ID',
                       ...
                       'Diseases Diagnosis 1', 'Diseases Diagnosis 2', 'Diseases Diagnosis 3', 'Diseases Diagnosis 4',
